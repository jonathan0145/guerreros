...
// import * as playerService from '../services/playerService'; // Ajusta el import según tu estructura
...
//   useEffect(() => {
//     // Aquí deberías obtener las cartas disponibles para el jugador
//     playerService.getAvailableCards(config)
...
//   const handleConfirm = () => {
//     // Aquí deberías guardar la selección en el backend
//     playerService.selectCardsForMatch(matchId, selected, config)
...
//             key={card.id}
//             style={{
//               border: selected.includes(card) ? '2px solid green' : '1px solid gray',
//               padding: 10,
//               cursor: 'pointer'
//             }}
...
//       .then(res => {
//         // Filtra solo los guerreros de este jugador
