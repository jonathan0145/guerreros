...
export const getAllRanking = (config) => axios.get(`${API_URL}/rankings`, config);
export const getRankingById = (id, config) => axios.get(`${API_URL}/ranking/${id}`, config);
export const createRanking = (data, config) => axios.post(`${API_URL}/ranking`, data, config);
export const updateRanking = (id, data, config) => axios.put(`${API_URL}/ranking/${id}`, data, config);
export const deleteRanking = (id, config) => axios.delete(`${API_URL}/ranking/${id}`, config);