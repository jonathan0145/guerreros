...
function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Si tu endpoint de admin es /api/login, usa esa ruta en vez de /api/loginplayer
      ...
      if (role === 'admin') {
        ...
        // Redirige a otra ruta si no es admin, por ejemplo a /login o / (ajusta según tu app)
        navigate('/');
      }
    } catch (err) {
